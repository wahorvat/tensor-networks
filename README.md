...
| :----------- | :------------ | :------------ |
| DMRG for finite fidelity random circuit sampling | [Density-Matrix Renormalization Group Algorithm for Simulating Quantum Circuits with a Finite Fidelity](https://arxiv.org/pdf/2207.05612) | [![Julia]( https://img.shields.io/badge/Julia-389826)](./DMRG-MPS%20julia/MPO_DMRG_itensors_julia.ipynb) |
| ITensors-based MPO DMRG | [Density-matrix renormalization group: a pedagogical introduction](https://arxiv.org/pdf/2304.13395) | [![Julia]( https://img.shields.io/badge/Julia-389826)](./DMRG-MPS%20julia/MPO_DMRG_itensors_julia.ipynb) |
